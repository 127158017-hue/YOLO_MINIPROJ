...
Because we made structural modifications to the source code (in `block.py`, `conv.py`, `__init__.py`, and `tasks.py`), you cannot just `pip install ultralytics` on Kaggle. You must use *this exact folder*.
